...
public class GachaTopActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.gachatop_activity_layout);
		//ボタンオブオブジェクト取得
	...
	class ButtonClickListener implements OnClickListener{
		public void onClick(View v){
			...
			Intent intent = new Intent(GachaTopActivity.this, ItemTopActivity.class);
